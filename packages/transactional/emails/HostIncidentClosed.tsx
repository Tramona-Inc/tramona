...
export default function HostIncidentClosed({
  hostName,
  claimCloseLink,
}: {
  hostName: string;
    ...
    <Layout title_preview="Incident Report Finalized">
      <div className="border-b border-gray-300 bg-white p-6 text-black">
        ...
        <Text className="mb-4 text-left">
          Dear {hostName},
          <br />
          The incident report regarding the traveler from your recent stay has
          now been finalized. You can view the details of the report by clicking
          the link below.
        ...
        <Text>
          ...
          further questions or wish to discuss the report, please reach out to
          us.
        </Text>
        <Text>
          Best regards, <br />
