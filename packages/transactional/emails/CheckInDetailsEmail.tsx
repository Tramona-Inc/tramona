...
export default function CheckInDetailsEmail({
    ...
    return (
        <Layout title_preview="Everything You Need for Your Stay - Check-In Details Enclosed!">
            ...
            <Text className="text-brand px-6 text-left text-base">
                Your trip is just around the corner! Here's everything you need for a smooth check-in experience.
            </Text>
            <Text className="text-brand px-6 text-left text-base">
            ...
            <Text className="text-brand px-6 text-left text-base">
                You can access these details anytime on your dashboard for peace of mind.
            </Text>
