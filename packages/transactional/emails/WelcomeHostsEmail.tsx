...
export default function WelcomeHostEmail({
    ...
    return (
        <Layout title_preview="Welcome to Tramona! Let's Start Booking Your Empty Nights">
            ...
            <Text className="text-brand px-6 text-left text-base">
                Welcome to Tramona! We’re thrilled to have you join our community of hosts who are filling their empty nights with happy travelers.
            </Text>
            <Text className="text-brand px-6 text-left text-base">
                Let's get your listing ready to attract guests. Completing your listing is quick and easy—just a few steps to showcase your space to thousands of potential travelers.
            </Text>
            <Text className="text-brand px-6 text-left text-base">
                Ready to get started? Click below to complete your listing and unlock the full potential of your property.
            </Text>
