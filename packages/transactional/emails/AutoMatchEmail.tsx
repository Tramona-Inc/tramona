...
export default function AutoMatchEmail({
  ...
  return (
    <Layout title_preview="Boost Your Bookings with Auto Matches!">
      ...
      <Text className="text-brand px-6 text-left text-base">
        Are you spending too much time managing booking requests without seeing
        the results you want? It&apos;s time to streamline your hosting
        experience with Auto Matches!
      </Text>
      <Text className="text-brand px-6 text-left text-base">
        With Auto Matches, you can effortlessly connect with travelers and
        increase your booking rate. {successExample}
      </Text>
      <Text className="text-brand px-6 text-left text-base">
        Setting up Auto Matches is quick and easy, and it ensures you never miss
        an opportunity to fill your property.
      </Text>
      <Section
      ...
      >
        <CustomButton
          link={autoMatchSetupLink}
          title="Set Up Auto Matches Now"
        />
      </Section>
    </Layout>
  );
