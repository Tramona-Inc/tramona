...
export const twilioRouter = createTRPCRouter({
  ...
  sendWhatsApp: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      } else if (templateId === "HX28c41122cfa312e326a9b5fc5e7bc255" || templateId === "HX74ffb496915d8e4ef39b41e624ca605e" || templateId === "HXa9200c7721c008928f1a932678727214" || templateId === "HXd7d55b299c2170bd5af4cef76e058d78") {
        contentVariables = {
          1: cost,
          2: name,
          3: dates,
