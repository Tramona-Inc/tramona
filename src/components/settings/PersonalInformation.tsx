...
function PersonalInformationForm({ session }: { session: Session }) {
  ...
  return (
    <div className="mx-auto h-full max-w-4xl xl:my-8">
      <div className="space-y-2 rounded-lg border bg-white p-4 md:space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} placeholder="Email" disabled={!isEditing} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
