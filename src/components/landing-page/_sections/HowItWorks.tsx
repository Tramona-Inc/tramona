...
const Step: React.FC<StepProps> = ({ number, title, description, isLast }) => (
  <div className="flex items-start">
    <div className="mr-4 flex flex-col items-center">
      <div
        className={`flex h-8 w-8 items-center justify-center rounded-full border-2 border-white text-xl font-bold text-black md:h-10 md:w-10 lg:text-2xl ${isLast ? "bg-white ring-2 ring-inset ring-black" : "bg-white ring-black"} text-sm`}
      >
        {number}
      </div>
      {!isLast && (
    ...
    <section className="relative bg-white p-2 md:px-2">
      <div className="flex flex-col md:flex-row">
        ...
        <div
          ...
          className="relative flex w-full rounded-3xl bg-neutral-900 bg-gradient-to-r from-neutral-900 to-neutral-950 p-10 shadow md:ml-4 md:w-8/12 "
        >
          <div className="flex h-full flex-col justify-between">
            <div
