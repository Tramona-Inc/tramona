  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primaryGreen text-white hover:bg-primaryGreen [&>*]:rounded-none hover:text-primary-foreground focus:bg-primaryGreen focus:text-white [&>button]:text-white aria-selected:text-white",
