  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
            {request ? "Update" : "Create"} a filler request
          </DialogTitle>
          <DialogDescription>
            {request ? "Update" : "Create"} a filler request with user name,
            travel time, location, request creation time, and nightly price
          </DialogDescription>
