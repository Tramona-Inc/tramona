        ...
        <div className="flex min-h-screen-minus-header items-start justify-center  px-4 pb-footer-height pt-5">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="flex flex-col items-start justify-start space-y-2 mb-4">
             <p className="text-sm font-bold sm:text-base"> Add artificial data:</p>
             <div className="flex gap-2 place-content-start">
              <CreateRequestDialog>
              ...
              <Button className="rounded-full" onClick={handleAutoGenerate}>One-Click Generate</Button>
              </div>
              <div className="flex items-center space-x-2">
              <Checkbox
                // defaultChecked={false}
                onCheckedChange={(checked) => {
                  return checked ? setFillerOnly(true) : setFillerOnly(false);
              }}
              />
              <p className="text-sm font-bold sm:text-base">Show filler only</p>
              </div>
              {isLoading && <Spinner />}
            </div>}
