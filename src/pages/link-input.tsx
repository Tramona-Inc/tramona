...
import { AddAirbnbLink } from "@/components/link-input/AddLink";
import { BaseSyntheticEvent, useState } from "react";
import { useCityRequestForm } from "@/components/landing-page/SearchBars/useCityRequestForm";
...
export default function Page() {
  ...
  const handleSubmit = async (data: any, event?: BaseSyntheticEvent) => {
            ...
            <div className="-mt-56 lg:-mt-36 flex flex-col justify-center">
              <div className="relative pt-10 text-center">
                ...
                <div className="mx-auto mt-8 max-w-3xl">
                  <Form {...form}>
                    <form onSubmit={handleSubmit} key={curTab}>
                      <AddAirbnbLink form={form} curTab={curTab} />
                    </form>
                  </Form>
                </div>
              </div>
